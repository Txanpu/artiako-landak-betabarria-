...
export const handleBribeGov = (state: GameState, pId: number): GameState => {
...
export const handleSabotageSupply = (state: GameState, tId: number): GameState => {
...
export const handleUseInsider = (state: GameState, pId: number): GameState => {
    const player = state.players.find(p => p.id === pId);
